...
const categories = [
  { name: "Pharmaceutical Tablets", text: "Information about tablet-based pharmaceutical product categories." },
  { name: "Capsules", text: "Company catalogue information for capsule product categories." },
  { name: "Syrups", text: "General information on syrup-based pharmaceutical categories." },
  { name: "Multivitamins", text: "Informational category for multivitamin products handled by the business." },
  { name: "Healthcare Products", text: "General healthcare category information for business customers." },
  { name: "Liquid Drops", text: "General category information for liquid and drops-based wellness products." },
];
  ...
  return (
    <main>
        ...
        <div className="container">
          ...
          <Reveal delay={90}>
            <div className={styles.networkStage}>
              ...
              <div className={styles.hub}><span className={styles.hubMark}>+</span><strong>SHREE SANVARIYA</strong><small>B2B CORPORATE NETWORK</small></div>
      ...
      <section className="section" id="categories">
        <div className="container">
          <Reveal><div className="sectionHead"><div><span className="eyebrow">PRODUCT INFORMATION</span><h2>Explore Our <span>Product Categories</span></h2><p>Different illustrative transparent product visuals for each category.</p></div></div></Reveal>
          <Reveal delay={80}><AnimatedProductGrid items={categories} showLink /></Reveal>
        </div>
      </section>

      <section className="section sectionTint" id="about">
        <div className="container aboutGrid">
          <Reveal><div className="aboutVisual"><div className="aboutPanel"><span className="microLabel">SHREE SANVARIYA</span><h3>Professional pharmaceutical business presence.</h3><p>Modern presentation built around trust, clarity and responsible communication.</p></div><div className="metricCard metricA"><strong>B2B</strong><small>Business Focus</small></div><div className="metricCard metricB"><strong>MP</strong><small>Bhopal Base</small></div></div></Reveal>
          <Reveal delay={110}><div className="aboutCopy"><span className="eyebrow">ABOUT THE COMPANY</span><h2>Your Professional <span>Trading Partner</span></h2><p>Shree Sanvariya Seth Traders is presented here as a professional pharmaceutical trading business based in Bhopal, Madhya Pradesh. This redesigned website focuses on company credibility, category-level product information and a clear corporate contact experience.</p><p>The website intentionally avoids unsupported certifications, medical claims and direct medicine checkout. Business discussions are handled through verified company contact channels.</p><div className="aboutPoints"><div><ShieldIcon />Responsible information</div><div><ChatIcon />Professional communication</div><div><GlobeIcon />Modern digital presence</div></div><a className="textLink" href="/about-us">Learn more about us <span>→</span></a></div></Reveal>
        </div>
      </section>

      <section className="section" id="why-us">
        <div className="container"><Reveal><div className="centerHead"><span className="eyebrow">WHY CHOOSE US</span><h2>Built Around <span>Trust & Professionalism</span></h2><p>A cleaner B2B experience with clear information and responsible communication.</p></div></Reveal><div className="valuesGrid">{values.map(([title, text], index) => <Reveal delay={index * 65} key={title}><article className="valueCard"><span>{String(index + 1).padStart(2,"0")}</span><h3>{title}</h3><p>{text}</p></article></Reveal>)}</div></div>
      </section>

      <section className="compliance" id="compliance"><div className="container complianceInner"><div><span className="eyebrow light">WEBSITE COMPLIANCE</span><h2>Corporate information only — no online medicine sale.</h2><p>This website does not provide an online checkout, direct medicine purchase, prescription fulfilment or controlled-drug ordering flow. Product information is presented at a general category level.</p></div><ShieldIcon /></div></section>

      <section className="section contactSection" id="contact"><div className="container contactGrid"><Reveal><div className="contactCopy"><span className="eyebrow">CONTACT</span><h2>Start a <span>Business Conversation</span></h2><p>For company-profile, institutional, vendor or general business communication, use the verified contact channel below.</p><div className="contactInfo"><div><strong>Location</strong><span>Bhopal, Madhya Pradesh, India</span></div><div><strong>Email</strong><a href="mailto:info@shreesanvariya.co.in">info@shreesanvariya.co.in</a></div></div></div></Reveal><Reveal delay={110}><div className="contactCard"><span className="contactBadge">GENERAL BUSINESS ENQUIRY</span><h3>Contact Shree Sanvariya Seth Traders</h3><p>Use email for corporate introductions, company information and permitted business correspondence.</p><a className="btn btnPrimary wide" href="mailto:info@shreesanvariya.co.in?subject=General%20Business%20Enquiry">Send an Email <span>→</span></a><small>No online medicine ordering is available through this website.</small></div></Reveal></div></section>
      <Footer />
    </main>
  );
}
